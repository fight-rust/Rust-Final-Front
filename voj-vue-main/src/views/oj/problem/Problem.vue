  ...
  <div :class="bodyClass">
    <div id="problem-main">
      ...
      <el-row class="problem-box">
        ...
        label="运行时间">
            ...
            <el-tab-pane v-if="userExtraFile" name="extraFile">
              <span slot="label"
              ...
              <div class="problem-detail">
                ...
                <div v-if="fileContent" class="markdown-body">
                  <h3>
                    {{ fileName }}
                    <el-button
                        circle
    ...
    <el-dialog :visible.sync="graphVisible" width="400px">
      <div id="pieChart-detail">
        <ECharts :initOptions="largePieInitOpts" :options="largePie"></ECharts>
      </div>
      <div slot="footer">
        <el-button size="small" type="ghost" @click="graphVisible = false">{{
            $t('m.Close')
          }}
        </el-button>
      </div>
