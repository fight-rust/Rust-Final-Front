export const m = {
  ...
  Import_User_Tips2: '共七列数据(“用户名”，“密码”，“邮箱”，“真实姓名”，“性别”，“昵称”，“学校”)：用户名和密码不能为空，其余选填',
  ...
  Extra_Account_Tips: '请输入允许参加比赛账号的用户名，每个用户名一行。',
  ...
  Delete_User_Tips: '确定要删除所选用户？可能会关联删除用户创建的公告，题目，比赛等。',
  Forbid_User_Tips: '确定要封禁所选用户？',
  Forbid_successfully: '封禁成功',
  ...
  Code_Visible_Start_Time: '用户可查看的提交代码',
  ...
  Display_ID: '展示ID',
  Display_Title: '展示标题',
  Add_Remote_OJ_Problem: '添加远程OJ题目',
  ...
  The_Problem_Display_ID_in_the_Contest_format_error: '比赛中的展示ID应为数字格式',
  ...
  Judge_Case_Iterate_Until_Wrong_Mode: '遇错止评（顺序评测）',
  ...
  Tag_Tips: '提示：默认所有标签都是【未分类】，请先【添加标签分类】，再修改标签的【标签分类】进行归类。',
