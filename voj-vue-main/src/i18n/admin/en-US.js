export const m = {
  ...
  Delete_Contest_Title:'contest ID',
  ...
  Forbid_User_Tips: 'Are you sure you want to forbid this user?',
  Forbid_successfully: 'Forbid Successfully',
  ...
  Problem_Switch: 'Problem Switch',
  Training_Switch: 'Training Switch',
  Contest_Switch: 'Contest Switch',
  Status_Switch: 'Status Switch',
  Rank_Switch: 'Rank Switch',
  Discussion_Switch: 'Discussion Switch',
  ...
  Interactive_Language: 'Interactive Program Language',
  Compile: 'Compile',
  ...
  Judge_Case_Iterate_Until_Wrong_Mode: 'Stop judge when wrong',
