export const m = {
  ...
  The_username_check_regular: '由字母数字下划线组成，首位必须为字母，长度不小于7位',
  ...
  Remember_Password_To_Login: '咦，好像记得密码? 请尝试登录!',
  ...
  Cancel_Avatar_Tips: '您确定取消该图像的截取？',
  ...
  Submitted_Failed_Description: '您的此次提交失败，请点击按钮重新提交...',
  ...
  Presentation_Error_Description: '您提交的代码已经很接近正确答案，请检查代码格式输出是否有多余空格，换行等空白符。',
  ...
  Announcement_of_contest_Q_and_A_area: '比赛问答区公告',
  ...
  Come_and_write_down_your_comments: '你的问题',
  Inline_Code: '行内代码',
  Code_Block: '代码块',
  Link: '链接',
  Unordered_list: '无序列表',
  ...
  Pick_up: '收起',
  Load_More: '加载更多',
  Delete_Comment_Tips: '此操作将删除该问题及其所有回复, 是否继续?',
